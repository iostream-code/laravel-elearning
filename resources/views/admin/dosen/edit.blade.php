...
@section('content')
    <form class="max-w-md" action="{{ route('dosen_update', $dosen) }}" method="POST">
        @csrf
        @method('PATCH')
        <div class="mb-5">
        ...
        <div class="grid md:grid-cols-2 md:gap-6 mb-5">
            <div class="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700">
                <input {{ $dosen->gender === 'pria' ? 'checked' : '' }} id="bordered-radio-1" type="radio" value="pria"
                    name="gender"
