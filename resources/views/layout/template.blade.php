...
<body>
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    ...
                    <ul id="pengguna" class="hidden py-2 space-y-2">
                        <li>
                            <a href="{{ route('dosen_index') }}"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Dosen</a>
                        </li>
                        <li>
                            <a href="{{ route('mahasiswa_index') }}"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Mahasiswa</a>
                        </li>
                    </ul>
                </li>
                @if (isset($subject))
                    <li>
                        <button type="button"
                            class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                            aria-controls="kelas" data-collapse-toggle="kelas">
                            <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                viewBox="0 0 18 18">
                                <path
                        ...
                        <ul id="kelas" class="hidden py-2 space-y-2">
                            @foreach ($subject as $data)
                                <li>
                                    <a href="#"
                                        class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">{{ $data->name }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </li>
    ...
    <div class="p-4 sm:ml-64">
        <header class="mb-2 text-2xl font-bold tracking-wide text-gray-900 dark:text-white mt-16">
            @yield('title')
